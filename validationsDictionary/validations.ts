...
function isNumeric(value: any): ValidationResult {
  ...
  if (strValue.includes('E') || strValue.includes('e')) {
    return {
      error: formatError(value, 'is in scientific notation and not allowed.'),
    }
  }
